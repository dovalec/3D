...
typedef struct bhdr_struct {
    ...
    unsigned int size;                /* bit 0 indicates whether the block is used and */
...
static inline void MAPPING_SEARCH(unsigned int * _r, int *_fl, int *_sl);
static inline void MAPPING_INSERT(unsigned int _r, int *_fl, int *_sl);
static inline bhdr_t *FIND_SUITABLE_BLOCK(tlsf_t * _tlsf, int *_fl, int *_sl);
static inline bhdr_t *process_area(void *area, unsigned int size);
#if USE_SBRK || USE_MMAP
static inline void *get_new_area(unsigned int * size);
#endif
...
/******************************************************************/
unsigned int init_memory_pool(unsigned int mem_pool_size, void *mem_pool)
{
/******************************************************************/
    tlsf_t *tlsf;
    bhdr_t *b, *ib;
...
/******************************************************************/
unsigned int add_new_area(void *area, unsigned int area_size, void *mem_pool)
{
/******************************************************************/
...
/******************************************************************/
unsigned int get_used_size(void *mem_pool)
{
/******************************************************************/
#if TLSF_STATISTIC
...
/******************************************************************/
unsigned int get_max_size(void *mem_pool)
{
/******************************************************************/
#if TLSF_STATISTIC
...
/******************************************************************/
void *malloc_ex(unsigned int size, void *mem_pool)
{
/******************************************************************/
    tlsf_t *tlsf = (tlsf_t *) mem_pool;
    bhdr_t *b, *b2, *next_b;
...
/******************************************************************/
void *realloc_ex(void *ptr, unsigned int new_size, void *mem_pool)
{
/******************************************************************/
    tlsf_t *tlsf = (tlsf_t *) mem_pool;
    void *ptr_aux;
...
/******************************************************************/
void *calloc_ex(unsigned int nelem, unsigned int elem_size, void *mem_pool)
{
/******************************************************************/
    void *ptr;
